const config = {
  password: "", // 管理面板使用密码 
  if password != null, then use this config; otherwise, read password from KV.
...
let index_html = "https://ranjiu20.github.io/Url-Shorten-Worker/" + config.theme + "/index.html"
let result_html = "https://ranjiu20.github.io/Url-Shorten-Worker/" + config.theme + "/result.html"
...
const html404 = `<!DOCTYPE html>
  ...
  <body>
    ...
    <p> <a href="https://github.com/RanJIU20/Url-Shorten-Worker" target="_self">Fork me on GitHub</a> </p>
  </body>
  </html>`
